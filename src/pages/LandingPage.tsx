        ...
        <div className=" p-10  w-3/4 bg-[#FAFAFA] h-screen ">
          <div className="flex justify-between ">
            ...
            <form className=" relative w-64 ">
              ...
              />
              <FiSearch className="absolute top-3 right-3 w-6 h-6 " />
            </form>
          </div>
          <div className="grid grid-cols-4  gap-4 mt-20">
            <div className="flex flex-col text-center content-center justify-center items-center border rounded-2xl shadow-lg h-96 gap-2 bg-white">
              <img
